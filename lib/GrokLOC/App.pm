...
our @EXPORT_OK =
  qw($X_GROKLOC_ID $X_GROKLOC_TOKEN $X_GROKLOC_TOKEN_REQUEST $AUTH_NONE $AUTH USER $AUTH_ORG $AUTH_ROOT $TOKEN_USER $TOKEN_ORG $TOKEN_ROOT $STASH_AUTH $STASH_USER $STASH_ORG);
our %EXPORT_TAGS = (
